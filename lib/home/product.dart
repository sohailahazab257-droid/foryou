  ...
  List<dynamic> get filteredProducts {
    if (selectedCategory == 'All') {
      return products.where((product) {
        return categoryGroups.values.expand((categories) => categories).contains(product['category']);
      }).toList();
    }
    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          color: isSelected ? const Color(0xffC9ECFF) : Colors.white.withOpacity(0.4),
