...
class _CategoriesProductsState extends State<CategoriesProducts> {
      ...
      if (category == 'All') {
        ...
        for (final categoryValue in categories.values) {
          final response = await http.get(
            Uri.parse('https://dummyjson.com/products/category/$categoryValue'),
          );
  ...
  Widget categoryButton({required String name, required String categoryValue}) {
    ...
    return Column(
      ...
      children: [
        SingleChildScrollView(
          ...
          child: Row(
            children: [
              categoryButton(name: 'All', categoryValue: 'All'),
...
class _ProductCardState extends State<ProductCard> {
  ...
  Widget build(BuildContext context) {
    ...
    final isInCart = CartStore.instance.isInCart(product);
    return GestureDetector(
      onTap: () {
        Navigator.push(
          context,
                ...
                children: [
                  ...
                  GestureDetector(
                    ...
                    child: Container(
                      ...
                      child: Icon(isInCart ? Icons.check : Icons.add, size: 21),
                    ),
                  ),
